...
class WordnetCorpus extends ReadCorpusAbstract
{
     ...
     * @return ExceptionMap
     */
    public function getExceptionMapFromString(string $line, string $pos)
    {
        $tokens = explode(" ", $line);
     ...
     * @return Synset
     */
    public function getSynsetByOffsetAndPos(int $synsetOffset, string $pos)
    {
     ...
     * @return Synset
     */
    public function getSynsetFromString(string $line)
    {
        $row = str_getcsv($line," ");
     ...
     * @return Lemma
     */
    public function getLemmaFromString(string $line)
    {
